  ...
  return (
    <SectionShell id="why-odette" gradientTone={1}>
      <div className="flex w-full max-w-6xl flex-col items-center">
        ...
        <div className="grid w-full items-stretch gap-3 sm:gap-4 md:grid-cols-2 md:gap-6 md:items-center">
          <StaggerGroup className="grid min-w-0 grid-cols-2 grid-rows-3 gap-2 self-stretch sm:gap-2.5 md:h-full md:gap-3 lg:gap-3">
            {features.map((feature) => (
              <StaggerItem key={feature} className="h-full min-h-0">
                <div className="group flex h-full min-h-[3.5rem] items-center gap-2 rounded-[14px] border border-cta/25 bg-white px-2.5 py-2.5 shadow-[0_8px_32px_rgba(91,45,139,0.08)] transition-all duration-300 hover:border-cta/45 hover:shadow-[0_16px_48px_rgba(91,45,139,0.12)] lg:gap-3 lg:rounded-[20px] lg:px-4 lg:py-3.5">
                  ...
                  <h3 className="min-w-0 flex-1 font-display text-[10px] font-medium leading-tight text-charcoal sm:text-xs md:text-sm md:leading-snug lg:text-sm lg:text-[15px]">
                    {feature}
                  </h3>
                </div>
              </StaggerItem>
